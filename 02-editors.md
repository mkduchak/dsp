...
I think I will be using emacs as my preferred editor. While nano is simple, it lacks some advanced functionality. I do not really like the vim interface either, so emacs seems to have more functionality with a better interface.
...
I will be using atom because I have used it before for other projects. An nice feature is how it works with github, so I think it will work better with updating my git hub.  The main shortcut is ctl+shift+p as this brings up the master command list. Other useful ones are ctl+o to open a file and ctrl+s to save. To customize the editor, I can install packages to do things like autocomplete and bookmark sections of text.
